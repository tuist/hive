...
hero:
  name: "Hive"
  text: "From product signal to shipped work."
  tagline: Bring product signals, shared plans, and shipped work into one place your whole team can follow.
  image:
    src: /logo.png
    alt: Hive
  actions:
    ...
    - theme: alt
      text: Self-host Hive
      link: /guide/self-hosting/installation
    - theme: alt
