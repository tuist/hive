defmodule Hive.Config.DevInstance do
  @moduledoc false
  ...
  @root_instance_file Path.join(@project_root, ".hive-dev-instance")
  @git_instance_name "hive-dev-instance"
  @env_var "HIVE_DEV_INSTANCE"
