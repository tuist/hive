...
- Every user-facing HTML page should include OpenGraph metadata with an image. Add page data in `HiveWeb.OpenGraph`, pass it through `OpenGraph.assigns/1` for LiveViews, or pass `open_graph:` into `Layouts.app` for controller-rendered pages.
