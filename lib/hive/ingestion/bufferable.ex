defmodule Hive.Ingestion.Bufferable do
  @moduledoc """
  ...
  Ported from `Tuist.Ingestion.Bufferable` in tuist/server.
  ...
  defmacro __using__(_opts) do
    quote do
      @before_compile Hive.Ingestion.Bufferable
    end
  end
  ...
  defmacro __before_compile__(env) do
    ...
    quote do
      def buffer_opts do
        Hive.Ingestion.Bufferable.compile_time_prepare(__MODULE__)
      end

      defmodule Buffer do
        @moduledoc false
        use Hive.Ingestion.Bufferable.BufferImpl, parent: unquote(parent)
      end
    end
  end
