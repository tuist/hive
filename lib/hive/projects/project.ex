defmodule Hive.Projects.Project do
  ...
  service the instance tracks. Projects own their meadows (sub-domains),
  ...
  schema "projects" do
    ...
    has_many :meadows, Hive.Meadows.Meadow
    has_many :github_repositories, Hive.Meadows.GitHubRepository
